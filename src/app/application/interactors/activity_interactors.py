...
class UpdateActivityInteractor:
    def __init__(
        self,
        activity_gateway: activity_interface.ActivityUpdater,
    ) -> None:
        self._activity_gateway = activity_gateway

    async def __call__(self, _id: str, update_data: dict) -> ActivityDM | None:
        return await self._activity_gateway.update(_id, update_data)